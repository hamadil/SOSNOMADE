            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        <h4 class="section-title ff-secondary text-start text-primary fw-normal mb-4">SOS NOMADE</h4>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Camp de Refugier Mberra , Mauritanie, zone3 bloc6</p>
                        <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+222 26006613/ +222 26339271</p>
                        <p class="mb-2"><i class="fa fa-envelope me-3"></i>sos.nomademl@gmail.com</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <h4 class="section-title ff-secondary text-start text-primary fw-normal mb-4">Horaire de Travail</h4>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="#">SOS NOMADE</a>, All Right Reserved. 
