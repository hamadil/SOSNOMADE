...
<head>
    <meta charset="utf-8">
    <title>SOS_Nomade- Bootstrap Restaurant Template</title>
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                <a href="<?php echo APPURL; ?>" class="navbar-brand p-0">
                    <h1 class="text-primary m-0"></i>SOS NOMADE  <img src="img/logo.jpg" alt="Logo"> </h1>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        <a href="<?php echo APPURL; ?>" class="nav-item nav-link active">Accueil</a>
                        <a href="<?php echo APPURL; ?>/about.php" class="nav-item nav-link">A propos</a>
